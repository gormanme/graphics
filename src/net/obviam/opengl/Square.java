...
public class Square {
	...
	public Square(float[] verts, float[] texCoords) {
	 ...
	 * @param context
	 */
	public void loadGLTexture(GL10 gl, Context context, int img_id) {

		// loading texture
		//the last value is the texture name. Make sure textures are in the drawable-hdpi folder
